...
export default function SectionHeader({ eyebrow, title, description, align = 'left' }) {
  return (
    ...
    >
      <p className="mb-4 inline-flex items-center gap-2 rounded-full border border-cyan-300/20 bg-cyan-300/10 px-4 py-2 font-mono text-[11px] font-bold uppercase tracking-[0.26em] text-cyan-200">
