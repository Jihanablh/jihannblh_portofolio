        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-24">
          ...
          <div>
            ...
            <div className="space-y-6">
              <a href={`mailto:${contactInfo.email}`} className="group flex items-start gap-4 p-5 bg-slate-900 border border-slate-800 rounded-2xl hover:border-blue-500/50 transition-all duration-300">
              ...
              <div className="pt-4">
                 <h4 className="text-slate-500 text-sm font-bold mb-4">Follow Me</h4>
                 <div className="flex gap-4">
                    <a href={contactInfo.linkedin} target="_blank" rel="noopener noreferrer" className="p-3 bg-slate-900 border border-slate-800 rounded-xl text-slate-400 hover:text-white hover:border-blue-500 transition-all duration-300">
                      <Linkedin size={20} />
                    </a>
                    <a href={contactInfo.github} target="_blank" rel="noopener noreferrer" className="p-3 bg-slate-900 border border-slate-800 rounded-xl text-slate-400 hover:text-white hover:border-purple-500 transition-all duration-300">
                      <Github size={20} />
                    </a>
                 </div>
              </div>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-8 sm:p-10 shadow-2xl relative overflow-hidden group">
            ...
            <form className="space-y-5 relative z-10" onSubmit={handleSubmit}>
              ...
              <button 
                type="submit"
                disabled={isSubmitting}
                className="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-500 text-white font-bold rounded-xl shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:-translate-y-1 hover:ring-1 hover:ring-blue-200/50 transition-all flex items-center justify-center gap-2 group/btn cursor-pointer disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:translate-y-0"
              >
                {isSubmitting ? (
                    <>
