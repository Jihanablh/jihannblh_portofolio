...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio interaktif Jihan Nabilah Rahman — Data Analyst, BI, dan People Analytics. Mengubah data kompleks menjadi keputusan bisnis." },
      { name: "author", content: "Jihan Nabilah Rahman" },
      { property: "og:title", content: "Jihan Nabilah Rahman — Data & Business Analyst" },
      { property: "og:description", content: "Portfolio 3D interaktif: dashboard, BI, GIS, dan analytics." },
